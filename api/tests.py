...
class PointsAPITests(TestCase):
    ...
    def test_add_points(self):
        ...
        self.assertEqual(points.closest_pairs, '2,2;4,5')
    ...
    def test_get_points(self):
        points = Points.objects.create(points='2,2;-1,30;20,11;4,5', closest_pairs='2,2;4,5')
        ...
        self.assertEqual(response.data['closest_pairs'], '2,2;4,5')
